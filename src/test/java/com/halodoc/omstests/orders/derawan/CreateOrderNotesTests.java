...
@Slf4j
@Feature("CREATE ORDER NOTES")
public class CreateOrderNotesTests extends OrdersBaseTest {
    List<MedisendOrderItem> medisendOrderItemsArray = new ArrayList<MedisendOrderItem>();

    @Severity(SeverityLevel.BLOCKER)
    @Description("VERIFY CREATE ORDER NOTES ORDER CREATED")
    @Test (groups = { "sanity", "regression" }, priority = 1)
    public void verifyCreateOrderNotesOrderCreated() {
        ...
        response = derawanHelper.createMedisendOrderNotes(customerOrderId, TYPE_ORDER_NOTE_CS, ORDER_NOTE_COMMENT);
        Assert.assertTrue(buruHelper.validateStatusCode(HttpStatus.OK, response));
