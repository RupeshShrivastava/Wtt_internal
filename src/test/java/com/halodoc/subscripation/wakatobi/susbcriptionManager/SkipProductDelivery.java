...
public class SkipProductDelivery {
    ...
    @Description ("order with 1 shipment and 1 subcribe product,skip 1st delivery")
    @Test
    public void shipment1SubscribeProduct1() throws InterruptedException {
        ...
        subscriptionManagerUtils.skipSubscriptionDelivery(userId,listingId);
